...
import { DataCard } from '../../types/ContactCard';

interface Props {
  data: DataCard
}

export const ContactsCard: FC<Props> = ({ data }) => {
  return (
    <div className="card-client">
      <div className="user-picture">
        <img src={data.photo} alt="" className="user-picture_image" />
      </div>
      ...
      <div className="social-media">
        <a href={`tel:${data.tel}`}>
          ...
          <span className="tooltip-social">Phone</span>
        </a>
        ...
        <a href={data.telegram} target="_blank" rel="noreferrer">
          ...
          <span className="tooltip-social">Telegram</span>
        </a>
